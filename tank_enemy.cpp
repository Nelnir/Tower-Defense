...
Tank_Enemy::Tank_Enemy(EnemyProporties *l_proporties, EnemyManager *l_manager) : EnemyBase(l_proporties, l_manager),
    m_tankProporties(dynamic_cast<TankProporties*>(l_proporties))
{
